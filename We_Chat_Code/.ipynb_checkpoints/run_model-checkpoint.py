...
def main():
    ...
    text_feature_dict={'des_words':50}
    ...
    for epoch in range(epochs):
        ...
        t3=time.time()
        print('epoch:{},auc:{},train cost:{:.2f}s,predict cost:{:.2f}s,auc cost:{:.2f}s'.format(epoch+1,auc,t1-t0,t2-t1,t3-t2))
